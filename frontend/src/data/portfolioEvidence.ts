...
export const portfolioEvidenceOverview = [
  ...
  },
  {
    ...
    status: "verified" as const,
    summary: {
      en: "Contract and tenure patterns come straight from the 7,043-row CSV, and model scores are regenerated by the repository's reproduce.py.",
      ko: "계약 유형과 이용 기간 패턴은 7,043행 원자료에서 직접 계산했고, 모형 수치는 저장소의 reproduce.py가 다시 만들어 냅니다.",
    },
  },
  {
    slug: "satellite-gdp",
    ...
    status: "verified" as const,
    summary: {
      en: "R-squared is recomputed from the SPSS analysis file by the repository's reproduce.py; the accompanying spreadsheet is misaligned and is flagged in the repository.",
      ko: "R²는 저장소의 reproduce.py가 SPSS 분석 파일에서 다시 계산합니다. 함께 있던 스프레드시트는 열이 어긋나 있어 저장소에 경고를 달아 두었습니다.",
    },
  },
  {
    slug: "korean-air",
...
export const portfolioEvidenceHighlights = [
  ...
  },
  {
    ...
    caution: {
      ...
      ko: "단순 회귀모형의 설명력이며, 예측 정확도나 인과관계를 뜻하지 않습니다.",
    },
  },
  {
    slug: "korean-air",
...
export const portfolioCardChips: Record<string, LocalizedText[]> = {
  ...
  "satellite-gdp": [
    ...
    { en: "R² 0.819 reproduced", ko: "R² 0.819 재현" },
  ],
  "korean-air": [
